                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" tabindex="1" class="form-control @error('firstname') is-invalid @enderror"
                    ...
                    <div class="col-sm-6 col-md-4">
                        ...
                        <div class="form-group">
                            <label>City</label>
                            <input type="text" tabindex="9" class="form-control @error('city') is-invalid @enderror"
